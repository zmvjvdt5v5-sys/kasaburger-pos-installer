...
DEFAULT_KIOSK_PRODUCTS = [
    ...
    {"id": "animal-chicken", "name": "Animal Style Chicken", "category": "Tavuk", "price": 430, "image": "https://res.cloudinary.com/dgxiovaqv/image/upload/v1768720160/kasaburger/products/jnzrcojxzkdrgb5u2exk.jpg", "available": True, "description": "Çıtır paneli tavuk göğsü, karamelize soğan, double cheddar, animal sos"},
    ...
    # YAN ÜRÜNLER
    {"id": "mac-cheese", "name": "Mac and Cheese Topları", "category": "Yan Ürün", "price": 170, "image": "https://res.cloudinary.com/dgxiovaqv/image/upload/v1768720009/kasaburger/products/lpmkvz6bhfewl5pgskic.jpg", "available": True},
    ...
    {"id": "sogan-halkasi", "name": "Soğan Halkası", "category": "Yan Ürün", "price": 180, "image": "https://res.cloudinary.com/dgxiovaqv/image/upload/v1768720240/kasaburger/products/dzxb0lv41xafeybynhri.jpg", "available": True, "description": "8 adet (yarım porsiyon patates ile)"},
    {"id": "cheese-fries", "name": "Prison Cheese Lover Fries", "category": "Yan Ürün", "price": 150, "image": "https://res.cloudinary.com/dgxiovaqv/image/upload/v1768720212/kasaburger/products/ujatmwdny3it8dzcikkn.jpg", "available": True, "description": "Cheddar soslu patates"},
    ...
    {"id": "oreo-dream", "name": "Oreo Dream Cup", "category": "Tatlı", "price": 220, "image": "https://res.cloudinary.com/dgxiovaqv/image/upload/v1768720424/kasaburger/products/uitufnzpxr7fatrttobr.jpg", "available": True},
]
